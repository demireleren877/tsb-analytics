    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          TSB'de yeni veri yayinlandiginda e-posta ile bilgilendirilmek icin abone olun
        </p>
      </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground">Son Veri Donemi</p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground">Kontrol Sikligi</p>
                <p className="text-2xl font-bold">Gunluk</p>
                <p className="text-xs text-muted-foreground">09:00 ve 18:00 UTC</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Yeni TSB verisi yayinlandiginda size otomatik olarak e-posta gonderilecektir
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Nasil Calisir?</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Sistem gunluk olarak TSB web sitesini yeni veri icin kontrol eder
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="font-semibold mb-1">Aninda Bildirim</h4>
                <p className="text-sm text-muted-foreground">
                  Yeni veri tespit edildiginde size e-posta ile bildirim gonderilir
                </p>
              </div>
            </div>
          </div>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="font-semibold mb-1">Bildirim Icerigi</h4>
              <p className="text-sm text-muted-foreground">
                TSB'de yeni "Sirketler Gelir Tablosu Detay" verisi yayinlandiginda, hangi donem icin veri
                yayinlandigini ve TSB Analytics'e erisim bilgilerini iceren bir e-posta alirsiniz.
                Her e-postada abonelikten cikmak icin bir baglanti bulunur.
              </p>
            </div>
          </div>
        </CardContent>
